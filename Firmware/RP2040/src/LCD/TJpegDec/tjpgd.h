...
#define JD_FORMAT       2   /* Output pixel format 0:RGB888 (3 uint8_t/pix)
                                                   1:RGB565 (1 uint16_t/pix),
                                                   2:RGB565 (1 uint16_t/pix, byte reversed) */
...
JRESULT jd_decomp (JDEC*, bool(*)(JDEC*,void*,JRECT*), uint8_t);
