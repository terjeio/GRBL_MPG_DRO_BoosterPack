...
/*
 * 2016-01-05: Mods by Terje Io (mainly updated to use portable data types)
 */
 ...
 *
 */
bool setCalibrationMatrix( POINT * displayPtr,
                          POINT * screenPtr,
                          MATRIX * matrixPtr)
{
 ...
 *
 */
bool getDisplayPoint(POINT * displayPtr,
                     POINT * screenPtr,
                     MATRIX * matrixPtr )
{
